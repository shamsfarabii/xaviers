    ...
    return (
        <div className='relative z-10 w-full overflow-visible bg-transparent'>
            <div className='relative mx-auto flex w-full max-w-[1440px] flex-col items-center gap-8 px-4 py-14 sm:gap-10 sm:px-6 sm:py-16 md:gap-12 md:px-8 md:py-20 lg:min-h-screen lg:flex-row lg:items-center lg:justify-between lg:gap-16 lg:px-12 lg:py-24 xl:gap-[100px] xl:px-16'>
                <div className=' z-0 flex w-full max-w-full shrink-0 items-center justify-center overflow-visible sm:max-w-[580px] md:max-w-[640px] lg:max-w-none lg:w-[48%] lg:justify-start'>
                    <img
                        src='/camera.png'
                        alt=''
                        aria-hidden='true'
                        className='pointer-events-none absolute left-[-20px] top-[60px] z-10 hidden h-auto w-[260px] lg:block'
                        draggable={false}
                    />
                    <img
                        src='/flimCard.png'
                        alt=''
                        aria-hidden='true'
                        className='pointer-events-none absolute bottom-[60px] right-[-120px] sm:right-[-150px] z-40 hidden h-auto w-[260px] lg:block'
                        draggable={false}
                    />
                    <img
                        src='/team.png'
                        alt='Xavier Media team collage'
                        className='z-0 h-auto w-full max-h-[min(480px,88vw)] object-contain select-none sm:max-h-[520px] md:max-h-[560px] lg:max-h-none'
                        draggable={false}
                    />
                </div>
