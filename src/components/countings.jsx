...
const AnimatedCard = ({ children, gradientClass, delay = 0 }) => {
    ...
    return (
        <div className={`relative group transform transition-all duration-1000 ${
            ...
            <div className="relative bg-gradient-to-br from-gray-900 to-black rounded-lg p-4 sm:p-6 md:p-8 lg:p-12 h-32 sm:h-36 md:h-40 lg:h-48 flex items-center justify-center border border-red-500">
                {children}
            </div>
        </div>
    );
